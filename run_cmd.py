...
cmds = [
    ...
    "python train_cmd.py --batch 8 --backbone mobilenetv2 --lr_type polynomial_decay --lr 0.001 --optimizer Gradient --require_improvement 300 --decay_rate 0.95 --Model_folder_name A_9"
    ...
    "python train_cmd.py --batch 8 --backbone mobilenetv2 --lr_type inverse_time_decay --lr 0.001 --optimizer Gradient --require_improvement 300 --decay_rate 0.95 --Model_folder_name A_11"
    ...
    "python train_cmd.py --batch 8 --backbone mobilenetv2 --lr_type polynomial_decay --lr 0.001 --optimizer Adam --require_improvement 300 --decay_rate 0.95 --Model_folder_name A_13"
    ...
    "python train_cmd.py --batch 8 --backbone mobilenetv2 --lr_type inverse_time_decay --lr 0.001 --optimizer Adam --require_improvement 300 --decay_rate 0.95 --Model_folder_name A_15"
    ...
    "python train_cmd.py --batch 8 --backbone mobilenetv2 --lr_type polynomial_decay --lr 0.001 --optimizer Momentum --require_improvement 300 --decay_rate 0.95 --Model_folder_name A_17"
    ...
    "python train_cmd.py --batch 8 --backbone mobilenetv2 --lr_type inverse_time_decay --lr 0.001 --optimizer Momentum --require_improvement 300 --decay_rate 0.95 --Model_folder_name A_19"
